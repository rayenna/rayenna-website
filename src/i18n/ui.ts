  ...
  ml: {
    ...
    pageConvert: {
      services: {
        ...
        ctaSub:
          '🏠 വീട്ടുപയോക്കൾക്ക് — സൗജന്യ കാൽക്കുലേറ്റർ ഉപയോഗിച്ച് 5 മിനിറ്റിൽ നിങ്ങളുടെ സിസ്റ്റം വലുപ്പം, സബ്സിഡി, 25 വർഷ ലാഭം കണ്ടെത്തൂ.',
        ctaSub2:
          '🏢 ബിസിനസ്സ് & കൺസൾട്ടേഷൻ — നിങ്ങളുടെ ആവശ്യം നേരിൽ മനസ്സിലാക്കി ശരിയായ പരിഹാരം നൽകാൻ ഞങ്ങളുടെ ടീം തയ്യാർ. ഇന്ന് വിളിക്കൂ.',
