...
const ui = {
  ...
  ml: {
    ...
    footer: {
      ...
      aboutText:
        'റയെന്ന എനർജി, നിങ്ങൾ ഊർജ്ജം ഉപയോഗിക്കുന്ന രീതി തന്നെ മാറ്റിയെഴുതാൻ പ്രതിജ്ഞാബദ്ധമായ ഒരു സോളാർ ഊർജ്ജ കമ്പനിയാണ്. ഗുണനിലവാരമുള്ള ഇൻസ്റ്റാളേഷനുകളിലൂടെ സുസ്ഥിരതയും കാര്യക്ഷമതയും താങ്ങാനാവുന്ന വിലയും ഉറപ്പാക്കിക്കൊണ്ട്, ഒരു പച്ചയായ നാളെ കെട്ടിപ്പടുക്കുക എന്നതാണ് ഞങ്ങളുടെ ലക്ഷ്യം.',
